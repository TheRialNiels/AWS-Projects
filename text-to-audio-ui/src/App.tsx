...
export default function App() {
  const CARDS = [
    ...
    },
    {
      ...
      description: 'Start using over 50+ SVG illustrations in 3D style to add character to your apps',
    ...
    {
      title: 'Flowbite Pro',
      description: 'Upgrade your development stack with more components and templates from Flowbite',
