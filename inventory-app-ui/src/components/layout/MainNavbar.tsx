...
const btnParams = {
  class:
    'text-primary-500! hover:bg-primary-100 focus:ring-primary-200 dark:text-primary-400! dark:hover:bg-primary-dark-700! dark:focus:ring-primary-dark-700 w-10 cursor-pointer rounded-lg border-none p-2.5 text-sm focus:ring-4 focus:outline-none',
  iconSize: 22.5,
}
...
export function MainNavbar() {
  return (
    ...
    >
      <NavbarBrand href="#">
        <span className="self-center px-2 py-1 text-xl font-semibold whitespace-nowrap dark:text-primary">
          Inventory App
        </span>
      </NavbarBrand>
